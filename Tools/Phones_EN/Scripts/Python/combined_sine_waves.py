...
with wave.open("combined_sine_wave.wav", "wb") as wf:
    ...
    wf.writeframes(combined_sine_wave.astype(bits_per_sample).tobytes())
...
with open("combined_sine_wave.series", "w", encoding="utf-8") as series_file:
    series_file.write("/* This file contains .WAV audio wth frames converted to integer series data for example training */\n")
